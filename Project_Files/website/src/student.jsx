...
const Student = ({ state }) => {
  ...
  const selectedSubjectRef = useRef(null); // Initialize with null
  const feedbackRef = useRef(null); // Initialize with null
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      console.error('Error submitting feedback:', error.message); // Display specific error message
      alert('Error submitting feedback: ' + error.message); // Display specific error message
    } finally {
      setIsLoading(false);
    }
  };
